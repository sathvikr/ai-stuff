...
class Parser:
    ...
    def parse(self):
        ...
        self.expression_tree = expression_stk[-1]
...
# regex = "(ab+)*a?b+a*"
# regex = "a|(ab|b*a)*"
regex = "a(a|b*)a|b+"  # missing a state
# regex = "(abc?|(cc)+)*"
parser = Parser(alphabet, regex)
parser.parse()
...
regexes = [
    ...
    "abbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbaa",
    "baaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabb"
]

# for regex in regexes:
#     print(compiler.matches(regex), regex)
# print(parsed_regex, ":", type(parsed_regex))
# print(parsed_regex.brzozowski_derivative("a"))
# test = Concat(RegEx.EPSILON, Star(Token("a")))
# print(type(test.brzozowski_derivative("b")))
# print(parser.expression_tree)
# print(type(parser.expression_tree), parser.expression_tree.a, parser.expression_tree.b)
# deriv = parser.expression_tree.brzozowski_derivative("a")
# print(deriv)
# deriv = deriv.brzozowski_derivative("b")
# print(deriv)
# print(deriv.a == deriv.b)
# print(deriv.a, deriv.b, type(deriv.a.b.token), type(deriv.b.b.token))
# print(deriv, type(deriv), deriv.a, deriv.b)
